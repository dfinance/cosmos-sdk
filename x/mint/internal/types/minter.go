...
func (m Minter) NextInflationRate(params Params, bondedRatio sdk.Dec, blocksPerYear uint64) sdk.Dec {
...
// provisions rate.
func (m Minter) BlockProvision(params Params, blocksPerYear uint64) sdk.Coin {
